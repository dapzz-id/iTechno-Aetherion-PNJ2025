...
Route::get('/{pageAuth}', function ($pageAuth) {
    return view('layouts.login');
})->where('pageAuth', 'login|register');
    ...
    if ($page === 'leaderboard') {
        $top3 = [
            [
                ...
                'likes' => 1400,
                'posts' => 150,
                'profile_picture' => 'https://i.pravatar.cc/?img=7',
            ],
            [
                'username' => 'Ataya',
                'likes' => 1900,
                'posts' => 200,
                'profile_picture' => 'https://i.pravatar.cc/?img=4',
            ],
            [
                'username' => 'Hanifah',
                'likes' => 900,
                'posts' => 100,
                'profile_picture' => 'https://i.pravatar.cc/?img=5',
            ],
        ];
